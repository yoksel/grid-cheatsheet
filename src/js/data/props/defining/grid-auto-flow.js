...
See <a href="#auto-placement-algo">§8.5 Grid Item Placement Algorithm</a> for details on precisely how the auto-placement algorithm works.</p>`,
  ...
  values: [
    ...
    {
      name: 'column',
      desc: 'The <a href="#grid-item-placement-algorithm">auto-placement algorithm</a> places items by filling each column in turn, adding new columns as necessary.'
    },
    {
      name: 'dense',
      desc: `If specified, the <a href="#grid-item-placement-algorithm">auto-placement algorithm</a> uses a “dense” packing algorithm, which attempts to fill in holes earlier in the grid if smaller items come up later. This may cause items to appear out-of-order, when doing so would fill in holes left by larger items.
