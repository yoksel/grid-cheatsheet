export default {
  ...
  values: [
    ...
    {
      name: 'column',
      desc: 'The <a data-link-type="dfn" href="https://www.w3.org/TR/css3-grid-layout/#grid-item-placement-algorithm" id="ref-for-grid-item-placement-algorithm④">auto-placement algorithm</a> places items by filling each column in turn, adding new columns as necessary.'
    },
    {
      name: 'dense',
      desc: `<p>If specified, the <a href="https://www.w3.org/TR/css3-grid-layout/#grid-item-placement-algorithm">auto-placement algorithm</a> uses a “dense” packing algorithm, which attempts to fill in holes earlier in the grid if smaller items come up later. This may cause items to appear out-of-order, when doing so would fill in holes left by larger items.</p>
