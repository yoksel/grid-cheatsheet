...
as <a href="https://www.w3.org/TR/css3-align/#row-gap">row-gap</a>, <a href="https://www.w3.org/TR/css3-align/#column-gap">column-gap</a> and <a href="https://www.w3.org/TR/css3-align/#justify-content">justify-content</a>, <a href="https://www.w3.org/TR/css3-align/#align-content">align-content</a> can add additional space between tracks.</p>`,

  values: [
    {
      name: 'none',
      desc: `Indicates that no <a href="#explicit-grid">explicit</a> grid tracks are created by this property
(though <a href="#explicit-grid">explicit grid</a> tracks could still be created by <a href="#grid-template-areas">grid-template-areas</a>).
