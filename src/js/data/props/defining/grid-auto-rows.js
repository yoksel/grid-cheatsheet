export default {
  ...
  desc: `<p>If a grid item is positioned into a row or column that is not explicitly sized by <a href="#grid-template-rows">grid-template-rows</a> or <a href="#grid-template-columns">grid-template-columns</a>, <a href="#implicit-grid-track">implicit grid tracks</a> are created to hold it. This can happen either by explicitly positioning into a row or column that is out of range, or by the <a href="https://www.w3.org/TR/css3-grid-layout/#grid-item-placement-algorithm">auto-placement algorithm</a> creating additional rows or columns.
