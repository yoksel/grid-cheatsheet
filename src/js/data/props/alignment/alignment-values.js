...
If the position of the alignment subjects within a <a href="#baseline-sharing-group">baseline-sharing group</a> is not fully constrained by <a href="#baseline-alignment">baseline alignment</a> (i.e., they could be shifted within their respective <a href="#alignment-container">alignment containers</a> while maintaining baseline-alignment),
they are <a href="#fallback-alignment">fallback-aligned</a> insofar as possible while preserving their baseline alignment.</p>
...
See <a href="#align-by-baseline">§ 9.3 Aligning Boxes by Baseline</a> for more details.
     <p>The <a href="#fallback-alignment">fallback alignment</a> for <a href="#justify-self-first-baseline">first baseline</a> is <code>safe self-start</code> (for <a href="#self-align">self-alignment</a>)
or <code>safe start</code> (for <a href="#content-distribute">content-distribution</a>).</p>
  </dd>
...
See <a href="#align-by-baseline">§ 9.3 Aligning Boxes by Baseline</a> for more details.
     <p>The <a href="#fallback-alignment">fallback alignment</a> for <a href="#justify-self-last-baseline">last baseline</a> is <code>safe self-end</code> (for <a href="#self-align">self-alignment</a>)
or <code>safe end</code> (for <a href="#content-distribute">content-distribution</a>).</p>
  </dd>
</dl>
...
The fallback alignment is also used to align the <a href="#baseline-sharing-group">baseline-sharing group</a> within its <a href="#alignment-container">alignment container</a>.</p>`
    },
...
the alignment subject is instead aligned as if the alignment mode were <a href="#self-position-start">start</a>.
  </dd>
...
and also by <a href="#justify-items">justify-items</a> and <a href="#align-items">align-items</a> (to specify default values for <code>justify-self</code> and <code>align-self</code>).
...
otherwise it computes to <code>normal</code>.</p>
     <p>When <code>justify-self:auto</code> references the value of <a href="#justify-items">justify-items</a>,
