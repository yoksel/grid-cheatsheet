export default {
  ...
  desc: `<p>Every <a href="https://www.w3.org/TR/css3-grid-layout/#grid-item">grid item</a> is associated with a <a href="https://www.w3.org/TR/css3-grid-layout/#grid-area">grid area</a>,
  a rectangular set of adjacent <a href="https://www.w3.org/TR/css3-grid-layout/#grid-cell">grid cells</a> that the <a href="https://www.w3.org/TR/css3-grid-layout/#grid-item">grid item</a> occupies.
  This <a href="https://www.w3.org/TR/css3-grid-layout/#grid-area">grid area</a> defines the <a href="https://www.w3.org/TR/css-display-3/#containing-block">containing block</a> for the <a href="https://www.w3.org/TR/css3-grid-layout/#grid-item">grid item</a> within which the self-alignment properties (<a href="https://www.w3.org/TR/css3-align/#justify-self">justify-self</a> and <a href="https://www.w3.org/TR/css3-align/#align-self">align-self</a>) determine their actual position.
  The cells that a <a href="https://www.w3.org/TR/css3-grid-layout/#grid-item">grid item</a> occupies also influence the sizing of the grid’s rows and columns,
  ...
  <dl>
   ...
   <p>The <dfn id="grid-placement-property">grid-placement properties</dfn>—<wbr>the longhands <a href="#grid-row-start">grid-row-start</a>, <a href="#grid-row-end">grid-row-end</a>, <a href="#grid-column-start">grid-column-start</a>, <a href="#grid-column-end">grid-column-end</a>, and their shorthands <a href="https://www.w3.org/TR/css3-grid-layout/#grid-row">grid-row</a>, <a href="#grid-column">grid-column</a>, and <a href="https://www.w3.org/TR/css3-grid-layout/#grid-area">grid-area</a>—<wbr>allow the author to specify a <a href="https://www.w3.org/TR/css3-grid-layout/#grid-item">grid item</a>’s <a href="#grid-placement">placement</a> by providing any (or none) of the following six pieces of information:</p>
